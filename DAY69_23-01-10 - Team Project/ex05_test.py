...
def main():
    ...
    ###### 수정해야 할 부분 !!!!!!!!!!!!!!!!!!!
    model = models.__dict__["efficientnet_b3"](pretrained=False)
    # model.classifier[1] = nn.Linear(in_features= 1536, out_features= 2) # efficientnet_b3처럼 분류모델 한번 더 들어가는건 .fc말고 .classifier[1]처럼 써줘야됨.
