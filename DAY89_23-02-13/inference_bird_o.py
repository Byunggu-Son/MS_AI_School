...
# model call
model = torch.hub.load('ultralytics/yolov5', 'custom', path="runs/train/exp_0209_bird_o2/weights/best.pt") ### 본인 경로에 맞게 수정
...
# image loader
image_dir = "./dataset_birds_o/valid/images" ### 본인 경로에 맞게 수정
...
tree._setroot(root)
tree.write("test_bird_o2.xml", encoding="utf-8")
