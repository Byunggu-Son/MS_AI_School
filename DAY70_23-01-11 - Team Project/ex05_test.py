...
def main():
    test_aug = A.Compose([
        ...
        A.CenterCrop(width= 200, height= 200),####### 200 으로 교체
    ...
    ###### 수정해야 할 부분 !!!!!!!!!!!!!!!!!!!
    model = models.__dict__["mobilenet_v3_large"](pretrained=False)
    model.classifier[3] = nn.Linear(in_features= 1280, out_features= 2) # efficientnet_b3처럼 분류모델 한번 더 들어가는건 .fc말고 .classifier[1]처럼 써줘야됨.
